...
public class RegistroUI {
    ...
    public static final Target INP_ANIO = Target.the("AÑO").located(By.id("com.exito.appcompania:id/filled_exposed_dropdown_anio_registro"));
    public static final Target SELECT_ANIO = Target.the("AÑO").locatedBy("//*[@text='"+ANIO+"']");
    public static final Target INP_MES = Target.the("MES").located(By.id("com.exito.appcompania:id/filled_exposed_dropdown_mes_registro"));
    public static final Target SELECT_MES = Target.the("MES").locatedBy("//*[@text='"+MES+"']");
    public static final Target INP_DIA = Target.the("DIA").located(By.id("com.exito.appcompania:id/filled_exposed_dropdown_dia_registro"));
